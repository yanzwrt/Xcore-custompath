...
\033[1;36m\033[0m Current version : ${orange}v${current_version} ${NC}
 ...
 Notes: 
❇️Please restart / reboot server after change Xray-core.
❇️If you using old XTLS, downgrade Xray-core v1.7.5 or below.
❇️Xray-core MOD support custom path / multipath. Only use it if your scripts support."
echo ""
