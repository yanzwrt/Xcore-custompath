...
\033[1;37mTelegram : https://t.me/Rakha_Putra21 \033[0m"
echo -e 
echo -e "
\033[1;36m\033[0m Versi Sebelumnya : ${orange}v${current_version} ${NC}
 ...
 [\033[1;36m•99\033[0m]  Cek Versi Xray-core
 [\033[1;36m• 0\033[0m]  Kembali ke menu
...
echo ""
read -p "Pilih Dari Options [ 1 - 99 ] :  " xcore
echo -e ""
case $xcore in
1)
clear
